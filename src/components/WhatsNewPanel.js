      ...
      >
        <Box p={2}>
          <Card sx={{ minWidth: "100%" }}>
            <CardMedia
              sx={{ height: 375, width: 450, backgroundSize: "cover" }}
              image="https://webapi.earthood.in/media/assets/earthscope/files/24e8569b-dc33-4603-b8ed-8c2f18f6470d5163e6dd-89cb-4133-ba92-b3c3_cIMTb40.png"
            />
            <CardContent>
